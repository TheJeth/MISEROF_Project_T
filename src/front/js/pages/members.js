                        ...
                        <div className="row">
                                ...
                                <div className="jumbotron justify-content-center text-end mx-auto col" style={{ width: "450px" }}>
                                        ...
                                        <div className="mb-3 row">
                                                ...
                                                <input value={last_name} onChange={(e) => setLast_name(e.target.value)} type="text" className="form-control col" id="formGroupExampleInput2" placeholder="Enter your last name here"></input>
                                        </div>

                                        <div className="mb-3 row">
                                                <p htmlFor="formGroupExampleInput2" className="col-3 ps-0"><b>Email:</b></p>
                                                <input value={email} onChange={(e) => setEmail(e.target.value)} type="text" className="form-control col" id="formGroupExampleInput2" placeholder="Enter your email address here"></input>
                                        </div>
